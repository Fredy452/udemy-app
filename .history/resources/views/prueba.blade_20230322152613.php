...
<body>
	<header class="bg-gray-800 text-white py-4">
		<div class="container mx-auto px-4">
			<h1 class="text-2xl font-bold text-center">Mi sitio web</h1>
		</div>
	</header>
	...
	<div class="bg-emerald-400 h-64">
		{{-- <img style="max-width: 100%;" src="https://hellocreatividad.com/app/uploads/2015/02/hello-blogging-pro.jpg" alt="img"> --}}
	</div>

	<div class="container mx-auto py-8">
		<h2 class="text-2xl font-bold mb-2">Últimas entradas</h2>
			...
			<div class="col-span-1">
				...
				<div class="col-span-2">
					<div class="bg-white p-4 rounded-lg shadow">
						...
						<ul>
							<li><a href="#" class="text-gray-700 hover:text-gray-600">Etiqueta 1</a></li>
							<li><a href="#" class="text-gray-700 hover:text-gray-600">Etiqueta 2</a></li>
							<li><a href="#" class="text-gray-700 hover:text-gray-600">Etiqueta 3</a></li>
						</ul>
					</div>
				</div>
			</div>
